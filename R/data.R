...
#' @description We illustrate the use of the <package.name> package with data on public policies
...
#' @title Public policy data on air pollution in the Valdivia commune, Chile.
#'
#' @description We illustrate the use of the <package.name> package with data on public
